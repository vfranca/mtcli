...
# chamada com 2 argumentos
    ...
    if p_times.match(arg2):
        bars = controller(file, times = int(arg2))
    elif p_date.match(arg2):
        bars = controller(file, date = arg2)
    elif p_show.match(arg2):
        bars = controller(file, view = arg2)
...
# chamada com 3 argumentos
    ...
    if p_date.match(arg2):
        if p_times.match(arg3):
            bars = controller(file, date = arg2, times = int(arg3))
        if p_show.match(arg3):
            bars = controller(file, date = arg2, view = arg3)

    # Quando o 2o argumento é um modo de exibição
    elif p_show.match(arg2):
        if p_times.match(arg3):
            bars = controller(file, view = arg2, times = int(arg3))
        elif p_date.match(arg3):
            bars = controller(file, view = arg2, date = arg3)
