...
bars = [
    bar(140500, 138900, 140200, 1000, 1500, 80, 10, 10, "verde"),
    bar(141500, 139800, 141200, 2000, 3000, 10, 10, 80, "verde"),
    bar(140500, 138900, 139000, 1800, 2800, 10, 80, 10, "vermelho"),
    bar(140200, 139100, 139800, 4000, 5000, 80, 10, 10, "verde"),
    bar(141500, 138800, 141300, 3000, 3500, 10, 10, 80, "verde"),
    bar(140500, 138900, 139200, 2000, 2500, 10, 80, 10, "vermelho"),
]
