...
class ReaderTestCase(TestCase):
    ...
    def test_filtro_por_data(self):
        ...
        self.assertEqual(candles[0], "107  engolfo alta branco33 neutro 76244 76199 76229 r45 76222 76266")
        candles = reader(self.file, date = "2018.09.13")
        self.assertEqual(candles[0], "1   branco88 fundo0 77359 77233 77344 r126 77296 77422")
