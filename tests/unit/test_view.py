...
class ViewTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.file = os.path.join(os.path.abspath("."), "tests", "fixtures", "files", "abev3daily.csv")
        self.bars = model.bar_model(self.file)
        self.bar = Bar(self.bars[4])

    def test_obtem_view_com_padroes_brooks(self):
        self.assertEqual(view.brooks_view(self.bar, "ASC", 1, "", 1.87), "1 ASC  VERMELHO20R0.05  BOTTOM56 17.59 17.34 17.48MP17.46 R0.25 1.87")

    def test_obtem_view_com_o_padrao_ohlc(self):
        self.assertEqual(view.ohlc_view(self.bar), "2017.06.29 17.53 17.59 17.34 17.48 14436")
