...
class ViewTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bars = _model.bar_model(self.file)
        self.bar = Bar(self.bars[4])

    def test_obtem_view_com_padroes_brooks(self):
        self.assertEqual(_view.brooks_view(self.bar, "ASC", 1, "", 1.87), "1 ASC  DOJI9R15.00  " + conf.lbl_toptail + "50 83241.00 83081.00 83161.00MP83161.00 R160.00 1.87")

    def test_obtem_view_com_o_padrao_ohlc(self):
        self.assertEqual(_view.ohlc_view(self.bar), "2018.01.04 83146.00 83241.00 83081.00 83161.00 6794")

    def test_obtem_view_de_canal(self):
        self.assertEqual(_view.channel_view(self.bar, "ASC", 1), "1 ASC 83241.00 83081.00")

    def test_obtem_view_com_precos_de_fechamento(self):
        self.assertEqual(_view.close_view(self.bar, 1), "1 83161.00")

    def test_obtem_view_com_maximas(self):
        self.assertEqual(_view.high_view(self.bar, 1), "1 83241.00")
