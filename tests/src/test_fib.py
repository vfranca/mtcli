...
class FibTestCase(TestCase):
    ...
    def test_saida_texto(self):
        self.assertEqual(self.obj.__str__(), "87849.4 88050.0 88250.6 | 89549.4 89750.0 89950.6", "Saída texto do objeto")
        self.assertEqual(self.obj2.__str__(), "88250.6 88050.0 87849.4 | 86550.6 86350.0 86149.4", "Saída texto do objeto")
