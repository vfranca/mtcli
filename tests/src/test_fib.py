...
class FibTestCase(TestCase):
    ...
    def test_saida_texto(self):
        self.assertEqual(self.obj.__str__(), "88050.0 > 89750.0", "Saída texto do objeto com tendência de alta")
        self.assertEqual(self.obj2.__str__(), "88050.0 > 86350.0", "Saída texto do objeto com tendência de baixa")
